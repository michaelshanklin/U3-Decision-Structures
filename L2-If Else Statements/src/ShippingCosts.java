public class ShippingCosts {
    ...
    public static void main(String[] args) {
        ...
        double shippingRate = Double.parseDouble(JOptionPane.showInputDialog("What is the weight of this item?"));
        int milesShipped = Integer.parseDouble(JOptionPane.showInputDialog("How many miles are you shipping it?"));
        double itemWeight;
        double cost;
